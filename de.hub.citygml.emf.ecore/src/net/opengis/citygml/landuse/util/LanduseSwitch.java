 ...
 * @generated
 */
public class LanduseSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LandusePackage modelPackage;
	 ...
	 * @generated
	 */
	public LanduseSwitch() {
		if (modelPackage == null) {
			modelPackage = LandusePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LandusePackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LandusePackage.LAND_USE_TYPE: {
				LandUseType landUseType = (LandUseType)theEObject;
				T result = caseLandUseType(landUseType);
				if (result == null) result = caseAbstractCityObjectType(landUseType);
				if (result == null) result = caseAbstractFeatureType(landUseType);
				if (result == null) result = caseAbstractGMLType(landUseType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Land Use Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Land Use Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLandUseType(LandUseType object) {
		return null;
	}

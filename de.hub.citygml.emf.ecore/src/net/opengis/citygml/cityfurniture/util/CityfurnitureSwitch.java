 ...
 * @generated
 */
public class CityfurnitureSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CityfurniturePackage.CITY_FURNITURE_TYPE: {
				CityFurnitureType cityFurnitureType = (CityFurnitureType)theEObject;
				T result = caseCityFurnitureType(cityFurnitureType);
				if (result == null) result = caseAbstractCityObjectType(cityFurnitureType);
				if (result == null) result = caseAbstractFeatureType(cityFurnitureType);
				if (result == null) result = caseAbstractGMLType(cityFurnitureType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CityfurniturePackage.DOCUMENT_ROOT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>City Furniture Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>City Furniture Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCityFurnitureType(CityFurnitureType object) {
		return null;
	}

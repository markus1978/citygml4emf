...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.GridPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GridPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public GridPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.GRID_PROPERTY_TYPE__RECTIFIED_GRID_COVERAGE);
		}
	...
	/**
	 * This returns GridPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GridPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((GridPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_GridPropertyType_type") :
			getString("_UI_GridPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GridPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.GRID_PROPERTY_TYPE__RECTIFIED_GRID_COVERAGE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == ReliefPackage.Literals.GRID_PROPERTY_TYPE__RECTIFIED_GRID_COVERAGE ||

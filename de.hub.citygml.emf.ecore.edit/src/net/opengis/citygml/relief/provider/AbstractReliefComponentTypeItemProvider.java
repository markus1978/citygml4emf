...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.AbstractReliefComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractReliefComponentTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractReliefComponentTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLodPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Lod feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractReliefComponentType_lod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractReliefComponentType_lod_feature", "_UI_AbstractReliefComponentType_type"),
				 ReliefPackage.Literals.ABSTRACT_RELIEF_COMPONENT_TYPE__LOD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.ABSTRACT_RELIEF_COMPONENT_TYPE__EXTENT);
			childrenFeatures.add(ReliefPackage.Literals.ABSTRACT_RELIEF_COMPONENT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_RELIEF_COMPONENT_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractReliefComponentType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractReliefComponentType_type") :
			getString("_UI_AbstractReliefComponentType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractReliefComponentType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.ABSTRACT_RELIEF_COMPONENT_TYPE__EXTENT,

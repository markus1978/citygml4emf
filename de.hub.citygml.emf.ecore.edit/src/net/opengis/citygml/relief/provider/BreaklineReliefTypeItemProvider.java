...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.BreaklineReliefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BreaklineReliefTypeItemProvider
	extends AbstractReliefComponentTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public BreaklineReliefTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__RIDGE_OR_VALLEY_LINES);
			childrenFeatures.add(ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__BREAKLINES);
			childrenFeatures.add(ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__GENERIC_APPLICATION_PROPERTY_OF_BREAKLINE_RELIEF_GROUP);
		}
	...
	/**
	 * This returns BreaklineReliefType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BreaklineReliefType"));
	}
	...
	public String getText(Object object) {
		String label = ((BreaklineReliefType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BreaklineReliefType_type") :
			getString("_UI_BreaklineReliefType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BreaklineReliefType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__RIDGE_OR_VALLEY_LINES,
				 GmlFactory.eINSTANCE.createMultiCurvePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__BREAKLINES,
				 GmlFactory.eINSTANCE.createMultiCurvePropertyType()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__RIDGE_OR_VALLEY_LINES ||
			childFeature == ReliefPackage.Literals.BREAKLINE_RELIEF_TYPE__BREAKLINES;

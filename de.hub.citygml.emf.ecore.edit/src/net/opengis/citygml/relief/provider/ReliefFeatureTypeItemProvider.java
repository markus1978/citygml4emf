...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.ReliefFeatureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReliefFeatureTypeItemProvider
	 ...
	 * @generated
	 */
	public ReliefFeatureTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReliefFeatureType_lod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReliefFeatureType_lod_feature", "_UI_ReliefFeatureType_type"),
				 ReliefPackage.Literals.RELIEF_FEATURE_TYPE__LOD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.RELIEF_FEATURE_TYPE__RELIEF_COMPONENT);
			childrenFeatures.add(ReliefPackage.Literals.RELIEF_FEATURE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_RELIEF_FEATURE_GROUP);
		}
	...
	/**
	 * This returns ReliefFeatureType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReliefFeatureType"));
	}
	...
	public String getText(Object object) {
		String label = ((ReliefFeatureType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ReliefFeatureType_type") :
			getString("_UI_ReliefFeatureType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ReliefFeatureType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.RELIEF_FEATURE_TYPE__RELIEF_COMPONENT,

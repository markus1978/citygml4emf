...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.MassPointReliefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MassPointReliefTypeItemProvider
	 ...
	 * @generated
	 */
	public MassPointReliefTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.MASS_POINT_RELIEF_TYPE__RELIEF_POINTS);
			childrenFeatures.add(ReliefPackage.Literals.MASS_POINT_RELIEF_TYPE__GENERIC_APPLICATION_PROPERTY_OF_MASS_POINT_RELIEF_GROUP);
		}
	...
	/**
	 * This returns MassPointReliefType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MassPointReliefType"));
	}
	...
	public String getText(Object object) {
		String label = ((MassPointReliefType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MassPointReliefType_type") :
			getString("_UI_MassPointReliefType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MassPointReliefType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.MASS_POINT_RELIEF_TYPE__RELIEF_POINTS,

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.RasterReliefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RasterReliefTypeItemProvider
	 ...
	 * @generated
	 */
	public RasterReliefTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.RASTER_RELIEF_TYPE__GRID);
			childrenFeatures.add(ReliefPackage.Literals.RASTER_RELIEF_TYPE__GENERIC_APPLICATION_PROPERTY_OF_RASTER_RELIEF_GROUP);
		}
	...
	/**
	 * This returns RasterReliefType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RasterReliefType"));
	}
	...
	public String getText(Object object) {
		String label = ((RasterReliefType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RasterReliefType_type") :
			getString("_UI_RasterReliefType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RasterReliefType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.RASTER_RELIEF_TYPE__GRID,

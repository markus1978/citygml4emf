...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.relief.TINReliefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TINReliefTypeItemProvider
	 ...
	 * @generated
	 */
	public TINReliefTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReliefPackage.Literals.TIN_RELIEF_TYPE__TIN);
			childrenFeatures.add(ReliefPackage.Literals.TIN_RELIEF_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TIN_RELIEF_GROUP);
		}
	...
	/**
	 * This returns TINReliefType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TINReliefType"));
	}
	...
	public String getText(Object object) {
		String label = ((TINReliefType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TINReliefType_type") :
			getString("_UI_TINReliefType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TINReliefType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReliefPackage.Literals.TIN_RELIEF_TYPE__TIN,

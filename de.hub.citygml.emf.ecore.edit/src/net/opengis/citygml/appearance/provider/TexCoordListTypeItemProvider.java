...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.appearance.TexCoordListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TexCoordListTypeItemProvider
	extends AbstractTextureParameterizationTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public TexCoordListTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.TEX_COORD_LIST_TYPE__TEXTURE_COORDINATES);
			childrenFeatures.add(AppearancePackage.Literals.TEX_COORD_LIST_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TEX_COORD_LIST_GROUP);
		}
	...
	/**
	 * This returns TexCoordListType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TexCoordListType"));
	}
	...
	public String getText(Object object) {
		String label = ((TexCoordListType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TexCoordListType_type") :
			getString("_UI_TexCoordListType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TexCoordListType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AppearancePackage.Literals.TEX_COORD_LIST_TYPE__TEXTURE_COORDINATES,
				 AppearanceFactory.eINSTANCE.createTextureCoordinatesType()));
	}

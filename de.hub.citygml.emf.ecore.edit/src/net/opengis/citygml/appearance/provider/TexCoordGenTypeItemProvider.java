...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.appearance.TexCoordGenType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TexCoordGenTypeItemProvider
	 ...
	 * @generated
	 */
	public TexCoordGenTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.TEX_COORD_GEN_TYPE__WORLD_TO_TEXTURE);
			childrenFeatures.add(AppearancePackage.Literals.TEX_COORD_GEN_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TEX_COORD_GEN_GROUP);
		}
	...
	/**
	 * This returns TexCoordGenType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TexCoordGenType"));
	}
	...
	public String getText(Object object) {
		String label = ((TexCoordGenType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TexCoordGenType_type") :
			getString("_UI_TexCoordGenType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TexCoordGenType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AppearancePackage.Literals.TEX_COORD_GEN_TYPE__WORLD_TO_TEXTURE,
				 AppearanceFactory.eINSTANCE.createWorldToTextureType()));
	}

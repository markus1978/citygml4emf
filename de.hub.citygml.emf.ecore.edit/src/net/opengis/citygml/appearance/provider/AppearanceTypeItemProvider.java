...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.appearance.AppearanceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppearanceTypeItemProvider
	 ...
	 * @generated
	 */
	public AppearanceTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AppearanceType_theme_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AppearanceType_theme_feature", "_UI_AppearanceType_type"),
				 AppearancePackage.Literals.APPEARANCE_TYPE__THEME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.APPEARANCE_TYPE__SURFACE_DATA_MEMBER);
			childrenFeatures.add(AppearancePackage.Literals.APPEARANCE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_APPEARANCE_GROUP);
		}
	...
	/**
	 * This returns AppearanceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AppearanceType"));
	}
	...
	public String getText(Object object) {
		String label = ((AppearanceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AppearanceType_type") :
			getString("_UI_AppearanceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AppearanceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AppearancePackage.Literals.APPEARANCE_TYPE__SURFACE_DATA_MEMBER,
				 AppearanceFactory.eINSTANCE.createSurfaceDataPropertyType()));
	}

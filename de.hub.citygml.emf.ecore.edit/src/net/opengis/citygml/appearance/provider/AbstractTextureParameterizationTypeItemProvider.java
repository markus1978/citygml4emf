...
import net.opengis.gml.provider.AbstractGMLTypeItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.appearance.AbstractTextureParameterizationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTextureParameterizationTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTextureParameterizationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.ABSTRACT_TEXTURE_PARAMETERIZATION_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TEXTURE_PARAMETERIZATION_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractTextureParameterizationType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTextureParameterizationType_type") :
			getString("_UI_AbstractTextureParameterizationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractTextureParameterizationType.class)) {

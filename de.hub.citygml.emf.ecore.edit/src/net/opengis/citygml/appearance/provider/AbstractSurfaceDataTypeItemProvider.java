...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.appearance.AbstractSurfaceDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractSurfaceDataTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractSurfaceDataTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsFrontPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Is Front feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsFrontPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractSurfaceDataType_isFront_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractSurfaceDataType_isFront_feature", "_UI_AbstractSurfaceDataType_type"),
				 AppearancePackage.Literals.ABSTRACT_SURFACE_DATA_TYPE__IS_FRONT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.ABSTRACT_SURFACE_DATA_TYPE__GENERIC_APPLICATION_PROPERTY_OF_SURFACE_DATA_GROUP);
		}
	...
	/**
	 * This returns AbstractSurfaceDataType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AbstractSurfaceDataType"));
	}
	...
	public String getText(Object object) {
		String label = ((AbstractSurfaceDataType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractSurfaceDataType_type") :
			getString("_UI_AbstractSurfaceDataType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractSurfaceDataType.class)) {

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.texturedsurface.AbstractAppearanceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractAppearanceTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractAppearanceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractAppearanceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractAppearanceType_type") :
			getString("_UI_AbstractAppearanceType_type") + " " + label;
	}

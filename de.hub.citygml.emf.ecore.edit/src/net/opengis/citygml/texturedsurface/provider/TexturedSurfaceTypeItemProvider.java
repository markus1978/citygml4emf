...
import net.opengis.gml.provider.OrientableSurfaceTypeItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.texturedsurface.TexturedSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TexturedSurfaceTypeItemProvider
	extends OrientableSurfaceTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public TexturedSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TexturedsurfacePackage.Literals.TEXTURED_SURFACE_TYPE__APPEARANCE);
		}
	...
	/**
	 * This returns TexturedSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TexturedSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((TexturedSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TexturedSurfaceType_type") :
			getString("_UI_TexturedSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TexturedSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TexturedsurfacePackage.Literals.TEXTURED_SURFACE_TYPE__APPEARANCE,

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.waterbody.WaterClosureSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WaterClosureSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public WaterClosureSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WaterbodyPackage.Literals.WATER_CLOSURE_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_WATER_CLOSURE_SURFACE_GROUP);
		}
	...
	/**
	 * This returns WaterClosureSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WaterClosureSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((WaterClosureSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_WaterClosureSurfaceType_type") :
			getString("_UI_WaterClosureSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WaterClosureSurfaceType.class)) {

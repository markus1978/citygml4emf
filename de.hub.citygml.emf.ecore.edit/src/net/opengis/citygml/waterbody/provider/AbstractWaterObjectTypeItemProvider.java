...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.waterbody.AbstractWaterObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractWaterObjectTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractWaterObjectTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WaterbodyPackage.Literals.ABSTRACT_WATER_OBJECT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_WATER_OBJECT_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractWaterObjectType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractWaterObjectType_type") :
			getString("_UI_AbstractWaterObjectType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractWaterObjectType.class)) {

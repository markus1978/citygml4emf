...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.waterbody.AbstractWaterBoundarySurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractWaterBoundarySurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractWaterBoundarySurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD2_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD3_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD4_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_WATER_BOUNDARY_SURFACE_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractWaterBoundarySurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractWaterBoundarySurfaceType_type") :
			getString("_UI_AbstractWaterBoundarySurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractWaterBoundarySurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD2_SURFACE,
				 GmlFactory.eINSTANCE.createSurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD3_SURFACE,
				 GmlFactory.eINSTANCE.createSurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD4_SURFACE,
				 GmlFactory.eINSTANCE.createSurfacePropertyType()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD2_SURFACE ||
			childFeature == WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD3_SURFACE ||
			childFeature == WaterbodyPackage.Literals.ABSTRACT_WATER_BOUNDARY_SURFACE_TYPE__LOD4_SURFACE;

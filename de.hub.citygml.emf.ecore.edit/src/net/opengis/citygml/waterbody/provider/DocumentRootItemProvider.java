...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.waterbody.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_BODY);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_BOUNDARY_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_CLOSURE_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_GROUND_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_OBJECT);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_WATER_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_BOUNDARY_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_OBJECT);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_BODY);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_CLOSURE_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_GROUND_SURFACE);
			childrenFeatures.add(WaterbodyPackage.Literals.DOCUMENT_ROOT__WATER_SURFACE);
		}

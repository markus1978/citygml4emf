...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.transportation.TrackType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrackTypeItemProvider
	 ...
	 * @generated
	 */
	public TrackTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransportationPackage.Literals.TRACK_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TRACK_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TrackType"));
	}
	...
	public String getText(Object object) {
		String label = ((TrackType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TrackType_type") :
			getString("_UI_TrackType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TrackType.class)) {

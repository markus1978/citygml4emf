...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.transportation.RoadType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoadTypeItemProvider
	 ...
	 * @generated
	 */
	public RoadTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransportationPackage.Literals.ROAD_TYPE__GENERIC_APPLICATION_PROPERTY_OF_ROAD_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoadType"));
	}
	...
	public String getText(Object object) {
		String label = ((RoadType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RoadType_type") :
			getString("_UI_RoadType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RoadType.class)) {

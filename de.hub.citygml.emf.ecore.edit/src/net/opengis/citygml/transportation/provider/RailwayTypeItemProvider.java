...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.transportation.RailwayType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RailwayTypeItemProvider
	extends TransportationComplexTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public RailwayTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransportationPackage.Literals.RAILWAY_TYPE__GENERIC_APPLICATION_PROPERTY_OF_RAILWAY_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RailwayType"));
	}
	...
	public String getText(Object object) {
		String label = ((RailwayType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RailwayType_type") :
			getString("_UI_RailwayType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RailwayType.class)) {

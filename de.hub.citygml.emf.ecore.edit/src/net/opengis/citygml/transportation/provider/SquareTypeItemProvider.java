...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.transportation.SquareType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SquareTypeItemProvider
	 ...
	 * @generated
	 */
	public SquareTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransportationPackage.Literals.SQUARE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_SQUARE_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SquareType"));
	}
	...
	public String getText(Object object) {
		String label = ((SquareType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SquareType_type") :
			getString("_UI_SquareType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SquareType.class)) {

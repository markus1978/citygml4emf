...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.transportation.AbstractTransportationObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTransportationObjectTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTransportationObjectTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransportationPackage.Literals.ABSTRACT_TRANSPORTATION_OBJECT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_TRANSPORTATION_OBJECT_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractTransportationObjectType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTransportationObjectType_type") :
			getString("_UI_AbstractTransportationObjectType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractTransportationObjectType.class)) {

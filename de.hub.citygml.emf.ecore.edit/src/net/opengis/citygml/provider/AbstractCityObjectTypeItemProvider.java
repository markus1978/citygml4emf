...
import net.opengis.gml.provider.AbstractFeatureTypeItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.AbstractCityObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCityObjectTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractCityObjectTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTerminationDatePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractCityObjectType_creationDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractCityObjectType_creationDate_feature", "_UI_AbstractCityObjectType_type"),
				 CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__CREATION_DATE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Termination Date feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTerminationDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractCityObjectType_terminationDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractCityObjectType_terminationDate_feature", "_UI_AbstractCityObjectType_type"),
				 CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__TERMINATION_DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__EXTERNAL_REFERENCE);
			childrenFeatures.add(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__GENERALIZES_TO);
			childrenFeatures.add(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_CITY_OBJECT_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractCityObjectType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCityObjectType_type") :
			getString("_UI_AbstractCityObjectType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractCityObjectType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__EXTERNAL_REFERENCE,
				 CitygmlFactory.eINSTANCE.createExternalReferenceType()));

		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__GENERALIZES_TO,
				 CitygmlFactory.eINSTANCE.createGeneralizationRelationType()));

		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ABSTRACT_CITY_OBJECT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_CITY_OBJECT_GROUP,

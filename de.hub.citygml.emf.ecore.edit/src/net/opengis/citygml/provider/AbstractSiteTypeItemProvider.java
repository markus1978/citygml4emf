...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.AbstractSiteType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractSiteTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractSiteTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.ABSTRACT_SITE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_SITE_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractSiteType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractSiteType_type") :
			getString("_UI_AbstractSiteType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractSiteType.class)) {

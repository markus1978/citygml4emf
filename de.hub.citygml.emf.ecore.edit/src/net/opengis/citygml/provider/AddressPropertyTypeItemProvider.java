...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.AddressPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public AddressPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.ADDRESS_PROPERTY_TYPE__ADDRESS);
		}
	...
	/**
	 * This returns AddressPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AddressPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((AddressPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_AddressPropertyType_type") :
			getString("_UI_AddressPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AddressPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ADDRESS_PROPERTY_TYPE__ADDRESS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == CitygmlPackage.Literals.ADDRESS_PROPERTY_TYPE__ADDRESS ||

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.ImplicitRepresentationPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImplicitRepresentationPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public ImplicitRepresentationPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.IMPLICIT_REPRESENTATION_PROPERTY_TYPE__IMPLICIT_GEOMETRY);
		}
	...
	/**
	 * This returns ImplicitRepresentationPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImplicitRepresentationPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((ImplicitRepresentationPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ImplicitRepresentationPropertyType_type") :
			getString("_UI_ImplicitRepresentationPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImplicitRepresentationPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.IMPLICIT_REPRESENTATION_PROPERTY_TYPE__IMPLICIT_GEOMETRY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == CitygmlPackage.Literals.IMPLICIT_REPRESENTATION_PROPERTY_TYPE__IMPLICIT_GEOMETRY ||

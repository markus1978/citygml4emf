...
import net.opengis.gml.provider.AbstractFeatureCollectionTypeItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.CityModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CityModelTypeItemProvider
	extends AbstractFeatureCollectionTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public CityModelTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.CITY_MODEL_TYPE__GENERIC_APPLICATION_PROPERTY_OF_CITY_MODEL_GROUP);
		}
	...
	/**
	 * This returns CityModelType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CityModelType"));
	}
	...
	public String getText(Object object) {
		String label = ((CityModelType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CityModelType_type") :
			getString("_UI_CityModelType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CityModelType.class)) {

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.AddressType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.ADDRESS_TYPE__XAL_ADDRESS);
			childrenFeatures.add(CitygmlPackage.Literals.ADDRESS_TYPE__MULTI_POINT);
			childrenFeatures.add(CitygmlPackage.Literals.ADDRESS_TYPE__GENERIC_APPLICATION_PROPERTY_OF_ADDRESS_GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ADDRESS_TYPE__XAL_ADDRESS,
				 CitygmlFactory.eINSTANCE.createXalAddressPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(CitygmlPackage.Literals.ADDRESS_TYPE__MULTI_POINT,

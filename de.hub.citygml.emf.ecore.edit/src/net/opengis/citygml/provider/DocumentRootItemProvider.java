...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__SITE);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__CITY_OBJECT);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_ADDRESS);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_CITY_MODEL);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_CITY_OBJECT);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__GENERIC_APPLICATION_PROPERTY_OF_SITE);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__ADDRESS);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__CITY_MODEL);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__CITY_OBJECT_MEMBER);
			childrenFeatures.add(CitygmlPackage.Literals.DOCUMENT_ROOT__IMPLICIT_GEOMETRY);
		}

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.vegetation.AbstractVegetationObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractVegetationObjectTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractVegetationObjectTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VegetationPackage.Literals.ABSTRACT_VEGETATION_OBJECT_TYPE__GENERIC_APPLICATION_PROPERTY_OF_VEGETATION_OBJECT_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractVegetationObjectType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractVegetationObjectType_type") :
			getString("_UI_AbstractVegetationObjectType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractVegetationObjectType.class)) {

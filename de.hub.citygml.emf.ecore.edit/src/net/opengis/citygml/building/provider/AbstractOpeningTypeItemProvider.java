...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.AbstractOpeningType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractOpeningTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractOpeningTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD3_MULTI_SURFACE);
			childrenFeatures.add(BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD4_MULTI_SURFACE);
			childrenFeatures.add(BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__GENERIC_APPLICATION_PROPERTY_OF_OPENING_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AbstractOpeningType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractOpeningType_type") :
			getString("_UI_AbstractOpeningType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractOpeningType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD3_MULTI_SURFACE,
				 GmlFactory.eINSTANCE.createMultiSurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD4_MULTI_SURFACE,
				 GmlFactory.eINSTANCE.createMultiSurfacePropertyType()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD3_MULTI_SURFACE ||
			childFeature == BuildingPackage.Literals.ABSTRACT_OPENING_TYPE__LOD4_MULTI_SURFACE;

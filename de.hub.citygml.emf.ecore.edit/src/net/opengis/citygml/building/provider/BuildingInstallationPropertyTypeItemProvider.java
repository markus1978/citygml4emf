...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.BuildingInstallationPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildingInstallationPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public BuildingInstallationPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.BUILDING_INSTALLATION_PROPERTY_TYPE__BUILDING_INSTALLATION);
		}
	...
	/**
	 * This returns BuildingInstallationPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BuildingInstallationPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((BuildingInstallationPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BuildingInstallationPropertyType_type") :
			getString("_UI_BuildingInstallationPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BuildingInstallationPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.BUILDING_INSTALLATION_PROPERTY_TYPE__BUILDING_INSTALLATION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BuildingPackage.Literals.BUILDING_INSTALLATION_PROPERTY_TYPE__BUILDING_INSTALLATION ||

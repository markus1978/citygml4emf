...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.InteriorWallSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteriorWallSurfaceTypeItemProvider
	extends AbstractBoundarySurfaceTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public InteriorWallSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.INTERIOR_WALL_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_INTERIOR_WALL_SURFACE_GROUP);
		}
	...
	/**
	 * This returns InteriorWallSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InteriorWallSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((InteriorWallSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_InteriorWallSurfaceType_type") :
			getString("_UI_InteriorWallSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InteriorWallSurfaceType.class)) {

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.RoofSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoofSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public RoofSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.ROOF_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_ROOF_SURFACE_GROUP);
		}
	...
	/**
	 * This returns RoofSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoofSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((RoofSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RoofSurfaceType_type") :
			getString("_UI_RoofSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RoofSurfaceType.class)) {

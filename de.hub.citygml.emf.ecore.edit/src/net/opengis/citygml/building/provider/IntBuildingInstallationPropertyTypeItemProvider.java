...
import net.opengis.gml.provider.AssociationTypeItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.IntBuildingInstallationPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntBuildingInstallationPropertyTypeItemProvider
	extends AssociationTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public IntBuildingInstallationPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.INT_BUILDING_INSTALLATION_PROPERTY_TYPE__INT_BUILDING_INSTALLATION);
		}
	...
	/**
	 * This returns IntBuildingInstallationPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IntBuildingInstallationPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((IntBuildingInstallationPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_IntBuildingInstallationPropertyType_type") :
			getString("_UI_IntBuildingInstallationPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntBuildingInstallationPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.INT_BUILDING_INSTALLATION_PROPERTY_TYPE__INT_BUILDING_INSTALLATION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BuildingPackage.Literals.INT_BUILDING_INSTALLATION_PROPERTY_TYPE__INT_BUILDING_INSTALLATION ||

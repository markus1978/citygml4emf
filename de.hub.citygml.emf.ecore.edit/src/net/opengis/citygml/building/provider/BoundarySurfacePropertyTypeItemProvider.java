...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.BoundarySurfacePropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoundarySurfacePropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public BoundarySurfacePropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.BOUNDARY_SURFACE_PROPERTY_TYPE__BOUNDARY_SURFACE_GROUP);
		}
	...
	/**
	 * This returns BoundarySurfacePropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BoundarySurfacePropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((BoundarySurfacePropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BoundarySurfacePropertyType_type") :
			getString("_UI_BoundarySurfacePropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BoundarySurfacePropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.BOUNDARY_SURFACE_PROPERTY_TYPE__BOUNDARY_SURFACE_GROUP,

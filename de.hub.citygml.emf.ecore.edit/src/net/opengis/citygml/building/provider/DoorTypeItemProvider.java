...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.DoorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoorTypeItemProvider
	extends AbstractOpeningTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public DoorTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.DOOR_TYPE__ADDRESS);
			childrenFeatures.add(BuildingPackage.Literals.DOOR_TYPE__GENERIC_APPLICATION_PROPERTY_OF_DOOR_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DoorType"));
	}
	...
	public String getText(Object object) {
		String label = ((DoorType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DoorType_type") :
			getString("_UI_DoorType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DoorType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.DOOR_TYPE__ADDRESS,

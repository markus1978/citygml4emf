...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.BuildingType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildingTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.BUILDING_TYPE__GENERIC_APPLICATION_PROPERTY_OF_BUILDING_GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BuildingType"));
	}
	...
	public String getText(Object object) {
		String label = ((BuildingType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BuildingType_type") :
			getString("_UI_BuildingType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BuildingType.class)) {

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.CeilingSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CeilingSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public CeilingSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.CEILING_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_CEILING_SURFACE_GROUP);
		}
	...
	/**
	 * This returns CeilingSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CeilingSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((CeilingSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CeilingSurfaceType_type") :
			getString("_UI_CeilingSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CeilingSurfaceType.class)) {

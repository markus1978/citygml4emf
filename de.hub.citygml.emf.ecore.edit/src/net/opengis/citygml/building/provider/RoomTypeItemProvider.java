...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.RoomType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoomType_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoomType_class_feature", "_UI_RoomType_type"),
				 BuildingPackage.Literals.ROOM_TYPE__CLASS,
				 true,
				 false,
				 false,
	...
	protected void addFunctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoomType_function_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoomType_function_feature", "_UI_RoomType_type"),
				 BuildingPackage.Literals.ROOM_TYPE__FUNCTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoomType_usage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoomType_usage_feature", "_UI_RoomType_type"),
				 BuildingPackage.Literals.ROOM_TYPE__USAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__LOD4_SOLID);
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__LOD4_MULTI_SURFACE);
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__BOUNDED_BY1);
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__INTERIOR_FURNITURE);
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__ROOM_INSTALLATION);
			childrenFeatures.add(BuildingPackage.Literals.ROOM_TYPE__GENERIC_APPLICATION_PROPERTY_OF_ROOM_GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((RoomType)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ROOM_TYPE__LOD4_SOLID,
				 GmlFactory.eINSTANCE.createSolidPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ROOM_TYPE__LOD4_MULTI_SURFACE,
				 GmlFactory.eINSTANCE.createMultiSurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ROOM_TYPE__BOUNDED_BY1,
				 BuildingFactory.eINSTANCE.createBoundarySurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ROOM_TYPE__INTERIOR_FURNITURE,
				 BuildingFactory.eINSTANCE.createInteriorFurniturePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.ROOM_TYPE__ROOM_INSTALLATION,

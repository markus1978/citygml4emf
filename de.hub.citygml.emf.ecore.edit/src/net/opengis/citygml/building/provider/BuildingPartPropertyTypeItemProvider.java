...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.BuildingPartPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildingPartPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public BuildingPartPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.BUILDING_PART_PROPERTY_TYPE__BUILDING_PART);
		}
	...
	/**
	 * This returns BuildingPartPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BuildingPartPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((BuildingPartPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BuildingPartPropertyType_type") :
			getString("_UI_BuildingPartPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BuildingPartPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.BUILDING_PART_PROPERTY_TYPE__BUILDING_PART,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BuildingPackage.Literals.BUILDING_PART_PROPERTY_TYPE__BUILDING_PART ||

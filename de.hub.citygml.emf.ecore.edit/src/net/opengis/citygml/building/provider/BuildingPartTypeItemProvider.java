...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.BuildingPartType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildingPartTypeItemProvider
	extends AbstractBuildingTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public BuildingPartTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.BUILDING_PART_TYPE__GENERIC_APPLICATION_PROPERTY_OF_BUILDING_PART_GROUP);
		}
	...
	/**
	 * This returns BuildingPartType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BuildingPartType"));
	}
	...
	public String getText(Object object) {
		String label = ((BuildingPartType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BuildingPartType_type") :
			getString("_UI_BuildingPartType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BuildingPartType.class)) {

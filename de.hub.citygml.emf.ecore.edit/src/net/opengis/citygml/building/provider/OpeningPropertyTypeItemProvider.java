...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.OpeningPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OpeningPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public OpeningPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.OPENING_PROPERTY_TYPE__OPENING_GROUP);
		}
	...
	/**
	 * This returns OpeningPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OpeningPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((OpeningPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_OpeningPropertyType_type") :
			getString("_UI_OpeningPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OpeningPropertyType.class)) {

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.InteriorRoomPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteriorRoomPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public InteriorRoomPropertyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.INTERIOR_ROOM_PROPERTY_TYPE__ROOM);
		}
	...
	/**
	 * This returns InteriorRoomPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InteriorRoomPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((InteriorRoomPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_InteriorRoomPropertyType_type") :
			getString("_UI_InteriorRoomPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InteriorRoomPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BuildingPackage.Literals.INTERIOR_ROOM_PROPERTY_TYPE__ROOM,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BuildingPackage.Literals.INTERIOR_ROOM_PROPERTY_TYPE__ROOM ||

...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.building.ClosureSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClosureSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public ClosureSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BuildingPackage.Literals.CLOSURE_SURFACE_TYPE__GENERIC_APPLICATION_PROPERTY_OF_CLOSURE_SURFACE_GROUP);
		}
	...
	/**
	 * This returns ClosureSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ClosureSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((ClosureSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ClosureSurfaceType_type") :
			getString("_UI_ClosureSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ClosureSurfaceType.class)) {

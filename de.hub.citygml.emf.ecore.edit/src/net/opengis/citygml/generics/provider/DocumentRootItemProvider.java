...
/**
 * This is the item provider adapter for a {@link net.opengis.citygml.generics.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__GENERIC_ATTRIBUTE);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__DATE_ATTRIBUTE);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__DOUBLE_ATTRIBUTE);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__GENERIC_CITY_OBJECT);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__INT_ATTRIBUTE);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__STRING_ATTRIBUTE);
			childrenFeatures.add(GenericsPackage.Literals.DOCUMENT_ROOT__URI_ATTRIBUTE);
		}

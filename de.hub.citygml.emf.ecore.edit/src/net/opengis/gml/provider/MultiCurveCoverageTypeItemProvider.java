...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiCurveCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiCurveCoverageTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiCurveCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiCurveCoverageType_MultiCurveDomain());
		}
	...
	/**
	 * This returns MultiCurveCoverageType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiCurveCoverageType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiCurveCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiCurveCoverageType_type") :
			getString("_UI_MultiCurveCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiCurveCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiCurveCoverageType_MultiCurveDomain(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getMultiCurveCoverageType_MultiCurveDomain() ||

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.LinearCSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinearCSTypeItemProvider
	 ...
	 * @generated
	 */
	public LinearCSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinearCSType"));
	}
	...
	public String getText(Object object) {
		String label = ((LinearCSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_LinearCSType_type") :
			getString("_UI_LinearCSType_type") + " " + label;
	}

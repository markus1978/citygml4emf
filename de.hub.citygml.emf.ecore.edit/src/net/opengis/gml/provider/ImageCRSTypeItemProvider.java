...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.ImageCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public ImageCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getImageCRSType_UsesCartesianCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getImageCRSType_UsesObliqueCartesianCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getImageCRSType_UsesImageDatum());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImageCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((ImageCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ImageCRSType_type") :
			getString("_UI_ImageCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImageCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getImageCRSType_UsesCartesianCS(),
				 GmlFactory.eINSTANCE.createCartesianCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getImageCRSType_UsesObliqueCartesianCS(),
				 GmlFactory.eINSTANCE.createObliqueCartesianCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getImageCRSType_UsesImageDatum(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OrientableCurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrientableCurveTypeItemProvider
	 ...
	 * @generated
	 */
	public OrientableCurveTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OrientableCurveType_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OrientableCurveType_orientation_feature", "_UI_OrientableCurveType_type"),
				 GmlPackage.eINSTANCE.getOrientableCurveType_Orientation(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getOrientableCurveType_BaseCurve());
		}
	...
	/**
	 * This returns OrientableCurveType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OrientableCurveType"));
	}
	...
	public String getText(Object object) {
		String label = ((OrientableCurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OrientableCurveType_type") :
			getString("_UI_OrientableCurveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OrientableCurveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOrientableCurveType_BaseCurve(),

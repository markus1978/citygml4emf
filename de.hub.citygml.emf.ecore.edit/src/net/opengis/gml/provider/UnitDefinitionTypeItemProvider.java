...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.UnitDefinitionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitDefinitionTypeItemProvider
	 ...
	 * @generated
	 */
	public UnitDefinitionTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getUnitDefinitionType_QuantityType());
			childrenFeatures.add(GmlPackage.eINSTANCE.getUnitDefinitionType_CatalogSymbol());
		}
	...
	/**
	 * This returns UnitDefinitionType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnitDefinitionType"));
	}
	...
	public String getText(Object object) {
		String label = ((UnitDefinitionType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UnitDefinitionType_type") :
			getString("_UI_UnitDefinitionType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnitDefinitionType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getUnitDefinitionType_QuantityType(),
				 GmlFactory.eINSTANCE.createStringOrRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getUnitDefinitionType_CatalogSymbol(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiPolygonType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiPolygonTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiPolygonTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiPolygonType_PolygonMember());
		}
	...
	/**
	 * This returns MultiPolygonType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiPolygonType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiPolygonType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiPolygonType_type") :
			getString("_UI_MultiPolygonType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiPolygonType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiPolygonType_PolygonMember(),

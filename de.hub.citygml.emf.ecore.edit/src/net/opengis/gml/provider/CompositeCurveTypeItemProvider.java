...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CompositeCurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeCurveTypeItemProvider
	 ...
	 * @generated
	 */
	public CompositeCurveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompositeCurveType_CurveMember());
		}
	...
	/**
	 * This returns CompositeCurveType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeCurveType"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeCurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeCurveType_type") :
			getString("_UI_CompositeCurveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeCurveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompositeCurveType_CurveMember(),

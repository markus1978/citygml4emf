...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.RectifiedGridType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RectifiedGridTypeItemProvider
	extends GridTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public RectifiedGridTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getRectifiedGridType_Origin());
			childrenFeatures.add(GmlPackage.eINSTANCE.getRectifiedGridType_OffsetVector());
		}
	...
	/**
	 * This returns RectifiedGridType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RectifiedGridType"));
	}
	...
	public String getText(Object object) {
		String label = ((RectifiedGridType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RectifiedGridType_type") :
			getString("_UI_RectifiedGridType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RectifiedGridType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getRectifiedGridType_Origin(),
				 GmlFactory.eINSTANCE.createPointPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getRectifiedGridType_OffsetVector(),

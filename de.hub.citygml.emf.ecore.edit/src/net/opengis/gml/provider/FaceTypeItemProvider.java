...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.FaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FaceTypeItemProvider
	extends AbstractTopoPrimitiveTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public FaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getFaceType_DirectedEdge());
			childrenFeatures.add(GmlPackage.eINSTANCE.getFaceType_DirectedTopoSolid());
			childrenFeatures.add(GmlPackage.eINSTANCE.getFaceType_SurfaceProperty());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((FaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_FaceType_type") :
			getString("_UI_FaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getFaceType_DirectedEdge(),
				 GmlFactory.eINSTANCE.createDirectedEdgePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getFaceType_DirectedTopoSolid(),
				 GmlFactory.eINSTANCE.createDirectedTopoSolidPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getFaceType_SurfaceProperty(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.VerticalCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VerticalCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public VerticalCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getVerticalCRSType_UsesVerticalCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getVerticalCRSType_UsesVerticalDatum());
		}
	...
	/**
	 * This returns VerticalCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VerticalCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((VerticalCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_VerticalCRSType_type") :
			getString("_UI_VerticalCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VerticalCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getVerticalCRSType_UsesVerticalDatum(),

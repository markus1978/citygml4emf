...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.DefinitionProxyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefinitionProxyTypeItemProvider
	 ...
	 * @generated
	 */
	public DefinitionProxyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getDefinitionProxyType_DefinitionRef());
		}
	...
	/**
	 * This returns DefinitionProxyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DefinitionProxyType"));
	}
	...
	public String getText(Object object) {
		String label = ((DefinitionProxyType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DefinitionProxyType_type") :
			getString("_UI_DefinitionProxyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DefinitionProxyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDefinitionProxyType_DefinitionRef(),

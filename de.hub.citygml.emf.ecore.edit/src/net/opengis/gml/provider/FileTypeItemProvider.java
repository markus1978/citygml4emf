...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.FileType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileTypeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFileStructurePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileType_fileName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileType_fileName_feature", "_UI_FileType_type"),
				 GmlPackage.eINSTANCE.getFileType_FileName(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the File Structure feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFileStructurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileType_fileStructure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileType_fileStructure_feature", "_UI_FileType_type"),
				 GmlPackage.eINSTANCE.getFileType_FileStructure(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCompressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileType_compression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileType_compression_feature", "_UI_FileType_type"),
				 GmlPackage.eINSTANCE.getFileType_Compression(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getFileType_RangeParameters());
		}
	...
	public String getText(Object object) {
		String label = ((FileType)object).getFileName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getFileType_RangeParameters(),

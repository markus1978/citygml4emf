...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.EllipsoidBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EllipsoidBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public EllipsoidBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getEllipsoidBaseType_EllipsoidName());
		}
	...
	public String getText(Object object) {
		String label = ((EllipsoidBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_EllipsoidBaseType_type") :
			getString("_UI_EllipsoidBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EllipsoidBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEllipsoidBaseType_EllipsoidName(),

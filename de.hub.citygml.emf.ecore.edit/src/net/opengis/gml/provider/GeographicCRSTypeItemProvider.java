...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.GeographicCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeographicCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public GeographicCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeographicCRSType_UsesEllipsoidalCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeographicCRSType_UsesGeodeticDatum());
		}
	...
	/**
	 * This returns GeographicCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeographicCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((GeographicCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_GeographicCRSType_type") :
			getString("_UI_GeographicCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeographicCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeographicCRSType_UsesEllipsoidalCS(),
				 GmlFactory.eINSTANCE.createEllipsoidalCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeographicCRSType_UsesGeodeticDatum(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TemporalDatumBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemporalDatumBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public TemporalDatumBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TemporalDatumBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TemporalDatumBaseType_type") :
			getString("_UI_TemporalDatumBaseType_type") + " " + label;
	}

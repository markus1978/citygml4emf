...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractCoordinateOperationBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCoordinateOperationBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractCoordinateOperationBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractCoordinateOperationBaseType_CoordinateOperationName());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractCoordinateOperationBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCoordinateOperationBaseType_type") :
			getString("_UI_AbstractCoordinateOperationBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractCoordinateOperationBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractCoordinateOperationBaseType_CoordinateOperationName(),

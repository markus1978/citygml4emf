...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTimeTopologyPrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTimeTopologyPrimitiveTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTimeTopologyPrimitiveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractTimeTopologyPrimitiveType_Complex());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractTimeTopologyPrimitiveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTimeTopologyPrimitiveType_type") :
			getString("_UI_AbstractTimeTopologyPrimitiveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractTimeTopologyPrimitiveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractTimeTopologyPrimitiveType_Complex(),

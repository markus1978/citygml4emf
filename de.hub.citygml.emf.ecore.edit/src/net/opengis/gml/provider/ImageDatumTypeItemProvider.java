...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.ImageDatumType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageDatumTypeItemProvider
	 ...
	 * @generated
	 */
	public ImageDatumTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getImageDatumType_PixelInCell());
		}
	...
	/**
	 * This returns ImageDatumType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImageDatumType"));
	}
	...
	public String getText(Object object) {
		String label = ((ImageDatumType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ImageDatumType_type") :
			getString("_UI_ImageDatumType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImageDatumType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getImageDatumType_PixelInCell(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getImageDatumType_PixelInCell();

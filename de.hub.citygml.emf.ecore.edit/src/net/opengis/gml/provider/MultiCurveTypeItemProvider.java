...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiCurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiCurveTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiCurveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiCurveType_CurveMember());
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiCurveType_CurveMembers());
		}
	...
	/**
	 * This returns MultiCurveType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiCurveType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiCurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiCurveType_type") :
			getString("_UI_MultiCurveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiCurveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiCurveType_CurveMember(),
				 GmlFactory.eINSTANCE.createCurvePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiCurveType_CurveMembers(),

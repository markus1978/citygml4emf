...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.LabelStyleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelStyleTypeItemProvider
	 ...
	 * @generated
	 */
	public LabelStyleTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getLabelStyleType_Label());
		}
	...
	/**
	 * This returns LabelStyleType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LabelStyleType"));
	}
	...
	public String getText(Object object) {
		String label = ((LabelStyleType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_LabelStyleType_type") :
			getString("_UI_LabelStyleType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LabelStyleType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getLabelStyleType_Label(),
				 GmlFactory.eINSTANCE.createLabelType()));
	}

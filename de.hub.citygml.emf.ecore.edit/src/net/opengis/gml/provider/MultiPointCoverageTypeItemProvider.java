...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiPointCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiPointCoverageTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiPointCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiPointCoverageType_MultiPointDomain());
		}
	...
	/**
	 * This returns MultiPointCoverageType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiPointCoverageType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiPointCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiPointCoverageType_type") :
			getString("_UI_MultiPointCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiPointCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiPointCoverageType_MultiPointDomain(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getMultiPointCoverageType_MultiPointDomain() ||

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.SurfacePropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SurfacePropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public SurfacePropertyTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_actuate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_actuate_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Actuate(),
				 true,
				 false,
				 false,
	...
	protected void addArcrolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_arcrole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_arcrole_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Arcrole(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_href_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_href_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Href(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRemoteSchemaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_remoteSchema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_remoteSchema_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_RemoteSchema(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_role_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Role(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_show_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_show_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Show(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_title_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Title(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfacePropertyType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfacePropertyType_type_feature", "_UI_SurfacePropertyType_type"),
				 GmlPackage.eINSTANCE.getSurfacePropertyType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getSurfacePropertyType_SurfaceGroup());
		}
	...
	/**
	 * This returns SurfacePropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SurfacePropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((SurfacePropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SurfacePropertyType_type") :
			getString("_UI_SurfacePropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SurfacePropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getSurfacePropertyType_SurfaceGroup(),

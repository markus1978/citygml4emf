...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeneralOperationParameterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeneralOperationParameterTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeneralOperationParameterTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractGeneralOperationParameterType_minimumOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractGeneralOperationParameterType_minimumOccurs_feature", "_UI_AbstractGeneralOperationParameterType_type"),
				 GmlPackage.eINSTANCE.getAbstractGeneralOperationParameterType_MinimumOccurs(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AbstractGeneralOperationParameterType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeneralOperationParameterType_type") :
			getString("_UI_AbstractGeneralOperationParameterType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractGeneralOperationParameterType.class)) {

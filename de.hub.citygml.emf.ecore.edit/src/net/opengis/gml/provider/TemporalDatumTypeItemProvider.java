...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TemporalDatumType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemporalDatumTypeItemProvider
	extends TemporalDatumBaseTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public TemporalDatumTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemporalDatumType_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemporalDatumType_origin_feature", "_UI_TemporalDatumType_type"),
				 GmlPackage.eINSTANCE.getTemporalDatumType_Origin(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns TemporalDatumType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemporalDatumType"));
	}
	...
	public String getText(Object object) {
		String label = ((TemporalDatumType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TemporalDatumType_type") :
			getString("_UI_TemporalDatumType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TemporalDatumType.class)) {

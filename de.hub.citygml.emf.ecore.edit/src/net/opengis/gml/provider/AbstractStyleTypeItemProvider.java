...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractStyleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractStyleTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractStyleTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractStyleType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractStyleType_type") :
			getString("_UI_AbstractStyleType_type") + " " + label;
	}

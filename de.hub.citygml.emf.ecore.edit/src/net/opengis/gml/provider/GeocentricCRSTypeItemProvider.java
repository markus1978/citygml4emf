...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.GeocentricCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeocentricCRSTypeItemProvider
	extends AbstractReferenceSystemTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public GeocentricCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesCartesianCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesSphericalCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesGeodeticDatum());
		}
	...
	/**
	 * This returns GeocentricCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeocentricCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((GeocentricCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_GeocentricCRSType_type") :
			getString("_UI_GeocentricCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeocentricCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesCartesianCS(),
				 GmlFactory.eINSTANCE.createCartesianCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesSphericalCS(),
				 GmlFactory.eINSTANCE.createSphericalCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeocentricCRSType_UsesGeodeticDatum(),

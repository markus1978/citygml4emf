...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.DirectedObservationAtDistanceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectedObservationAtDistanceTypeItemProvider
	extends DirectedObservationTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public DirectedObservationAtDistanceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getDirectedObservationAtDistanceType_Distance());
		}
	...
	/**
	 * This returns DirectedObservationAtDistanceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DirectedObservationAtDistanceType"));
	}
	...
	public String getText(Object object) {
		String label = ((DirectedObservationAtDistanceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DirectedObservationAtDistanceType_type") :
			getString("_UI_DirectedObservationAtDistanceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DirectedObservationAtDistanceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDirectedObservationAtDistanceType_Distance(),

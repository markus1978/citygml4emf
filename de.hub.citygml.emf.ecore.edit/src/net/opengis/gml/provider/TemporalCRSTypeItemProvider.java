...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TemporalCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemporalCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public TemporalCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTemporalCRSType_UsesTemporalCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getTemporalCRSType_UsesTemporalDatum());
		}
	...
	/**
	 * This returns TemporalCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemporalCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((TemporalCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TemporalCRSType_type") :
			getString("_UI_TemporalCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TemporalCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTemporalCRSType_UsesTemporalCS(),
				 GmlFactory.eINSTANCE.createTemporalCSRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTemporalCRSType_UsesTemporalDatum(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeneralConversionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeneralConversionTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeneralConversionTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractGeneralConversionType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeneralConversionType_type") :
			getString("_UI_AbstractGeneralConversionType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.StyleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StyleTypeItemProvider
	extends AbstractStyleTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public StyleTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getStyleType_FeatureStyle());
			childrenFeatures.add(GmlPackage.eINSTANCE.getStyleType_GraphStyle());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StyleType"));
	}
	...
	public String getText(Object object) {
		String label = ((StyleType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_StyleType_type") :
			getString("_UI_StyleType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StyleType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getStyleType_FeatureStyle(),
				 GmlFactory.eINSTANCE.createFeatureStylePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getStyleType_GraphStyle(),

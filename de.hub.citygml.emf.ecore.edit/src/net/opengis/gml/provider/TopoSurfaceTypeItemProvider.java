...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TopoSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TopoSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public TopoSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTopoSurfaceType_DirectedFace());
		}
	...
	/**
	 * This returns TopoSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TopoSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((TopoSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TopoSurfaceType_type") :
			getString("_UI_TopoSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TopoSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTopoSurfaceType_DirectedFace(),

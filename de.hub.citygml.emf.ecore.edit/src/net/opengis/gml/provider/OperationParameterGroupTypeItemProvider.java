...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OperationParameterGroupType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationParameterGroupTypeItemProvider
	extends OperationParameterGroupBaseTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public OperationParameterGroupTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationParameterGroupType_maximumOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationParameterGroupType_maximumOccurs_feature", "_UI_OperationParameterGroupType_type"),
				 GmlPackage.eINSTANCE.getOperationParameterGroupType_MaximumOccurs(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns OperationParameterGroupType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperationParameterGroupType"));
	}
	...
	public String getText(Object object) {
		String label = ((OperationParameterGroupType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationParameterGroupType_type") :
			getString("_UI_OperationParameterGroupType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationParameterGroupType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOperationParameterGroupType_GroupID(),
				 GmlFactory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOperationParameterGroupType_Remarks(),
				 GmlFactory.eINSTANCE.createStringOrRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOperationParameterGroupType_IncludesParameter(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getOperationParameterGroupType_Remarks() ||

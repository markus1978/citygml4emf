...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TopoSolidType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TopoSolidTypeItemProvider
	 ...
	 * @generated
	 */
	public TopoSolidTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTopoSolidType_DirectedFace());
		}
	...
	/**
	 * This returns TopoSolidType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TopoSolidType"));
	}
	...
	public String getText(Object object) {
		String label = ((TopoSolidType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TopoSolidType_type") :
			getString("_UI_TopoSolidType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TopoSolidType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTopoSolidType_DirectedFace(),

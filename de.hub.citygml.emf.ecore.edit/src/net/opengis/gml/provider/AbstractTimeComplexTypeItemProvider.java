...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTimeComplexType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTimeComplexTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTimeComplexTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractTimeComplexType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTimeComplexType_type") :
			getString("_UI_AbstractTimeComplexType_type") + " " + label;
	}

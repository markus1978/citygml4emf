...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.EdgeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getEdgeType_DirectedNode());
			childrenFeatures.add(GmlPackage.eINSTANCE.getEdgeType_DirectedFace());
			childrenFeatures.add(GmlPackage.eINSTANCE.getEdgeType_CurveProperty());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEdgeType_DirectedNode(),
				 GmlFactory.eINSTANCE.createDirectedNodePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEdgeType_DirectedFace(),
				 GmlFactory.eINSTANCE.createDirectedFacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEdgeType_CurveProperty(),

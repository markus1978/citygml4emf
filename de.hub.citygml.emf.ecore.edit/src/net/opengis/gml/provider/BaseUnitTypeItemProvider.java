...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.BaseUnitType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseUnitTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getBaseUnitType_UnitsSystem());
		}
	...
	public String getText(Object object) {
		String label = ((BaseUnitType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BaseUnitType_type") :
			getString("_UI_BaseUnitType_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getBaseUnitType_UnitsSystem(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.RingType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RingTypeItemProvider
	 ...
	 * @generated
	 */
	public RingTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getRingType_CurveMember());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RingType"));
	}
	...
	public String getText(Object object) {
		String label = ((RingType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RingType_type") :
			getString("_UI_RingType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RingType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getRingType_CurveMember(),

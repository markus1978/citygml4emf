...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractRingType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractRingTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractRingTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractRingType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractRingType_type") :
			getString("_UI_AbstractRingType_type") + " " + label;
	}

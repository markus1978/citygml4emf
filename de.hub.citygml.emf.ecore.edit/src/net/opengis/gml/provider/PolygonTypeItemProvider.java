...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.PolygonType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolygonTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getPolygonType_ExteriorGroup());
			childrenFeatures.add(GmlPackage.eINSTANCE.getPolygonType_InteriorGroup());
		}
	...
	public String getText(Object object) {
		String label = ((PolygonType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_PolygonType_type") :
			getString("_UI_PolygonType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PolygonType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPolygonType_ExteriorGroup(),
				 FeatureMapUtil.createEntry
					(GmlPackage.eINSTANCE.getPolygonType_Exterior(),
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPolygonType_InteriorGroup(),
				 FeatureMapUtil.createEntry
					(GmlPackage.eINSTANCE.getPolygonType_Interior(),
					 GmlFactory.eINSTANCE.createAbstractRingPropertyType())));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getPolygonType_Exterior() ||
			childFeature == GmlPackage.eINSTANCE.getDocumentRoot_OuterBoundaryIs() ||
			childFeature == GmlPackage.eINSTANCE.getPolygonType_Interior() ||

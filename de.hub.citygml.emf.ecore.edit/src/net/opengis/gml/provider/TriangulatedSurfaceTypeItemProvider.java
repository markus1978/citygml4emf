...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TriangulatedSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriangulatedSurfaceTypeItemProvider
	extends SurfaceTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public TriangulatedSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTriangulatedSurfaceType_TrianglePatches());
		}
	...
	/**
	 * This returns TriangulatedSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TriangulatedSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((TriangulatedSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TriangulatedSurfaceType_type") :
			getString("_UI_TriangulatedSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TriangulatedSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTriangulatedSurfaceType_TrianglePatches(),

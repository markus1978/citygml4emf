...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OrientableSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrientableSurfaceTypeItemProvider
	extends AbstractSurfaceTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public OrientableSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OrientableSurfaceType_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OrientableSurfaceType_orientation_feature", "_UI_OrientableSurfaceType_type"),
				 GmlPackage.eINSTANCE.getOrientableSurfaceType_Orientation(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getOrientableSurfaceType_BaseSurface());
		}
	...
	/**
	 * This returns OrientableSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OrientableSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((OrientableSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OrientableSurfaceType_type") :
			getString("_UI_OrientableSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OrientableSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOrientableSurfaceType_BaseSurface(),

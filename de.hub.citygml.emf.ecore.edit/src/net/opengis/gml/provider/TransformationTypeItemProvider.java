...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TransformationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationTypeItemProvider
	extends AbstractGeneralTransformationTypeItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTransformationType_UsesMethod());
			childrenFeatures.add(GmlPackage.eINSTANCE.getTransformationType_UsesValue());
		}
	...
	public String getText(Object object) {
		String label = ((TransformationType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TransformationType_type") :
			getString("_UI_TransformationType_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTransformationType_UsesMethod(),
				 GmlFactory.eINSTANCE.createOperationMethodRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTransformationType_UsesValue(),

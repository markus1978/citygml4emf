...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiSolidCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiSolidCoverageTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiSolidCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSolidCoverageType_MultiSolidDomain());
		}
	...
	/**
	 * This returns MultiSolidCoverageType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiSolidCoverageType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiSolidCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiSolidCoverageType_type") :
			getString("_UI_MultiSolidCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiSolidCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSolidCoverageType_MultiSolidDomain(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getMultiSolidCoverageType_MultiSolidDomain() ||

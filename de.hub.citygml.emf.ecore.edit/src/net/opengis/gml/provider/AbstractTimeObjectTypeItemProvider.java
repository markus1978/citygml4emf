...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTimeObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTimeObjectTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTimeObjectTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractTimeObjectType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTimeObjectType_type") :
			getString("_UI_AbstractTimeObjectType_type") + " " + label;
	}

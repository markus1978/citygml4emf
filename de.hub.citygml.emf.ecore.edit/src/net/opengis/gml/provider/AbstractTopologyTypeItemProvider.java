...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTopologyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTopologyTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTopologyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractTopologyType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTopologyType_type") :
			getString("_UI_AbstractTopologyType_type") + " " + label;
	}

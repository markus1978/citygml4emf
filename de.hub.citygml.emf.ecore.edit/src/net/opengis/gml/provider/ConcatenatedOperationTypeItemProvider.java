...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.ConcatenatedOperationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcatenatedOperationTypeItemProvider
	 ...
	 * @generated
	 */
	public ConcatenatedOperationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getConcatenatedOperationType_UsesSingleOperation());
		}
	...
	/**
	 * This returns ConcatenatedOperationType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConcatenatedOperationType"));
	}
	...
	public String getText(Object object) {
		String label = ((ConcatenatedOperationType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ConcatenatedOperationType_type") :
			getString("_UI_ConcatenatedOperationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConcatenatedOperationType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getConcatenatedOperationType_UsesSingleOperation(),

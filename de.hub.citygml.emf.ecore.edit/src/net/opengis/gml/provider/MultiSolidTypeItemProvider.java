...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiSolidType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiSolidTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiSolidTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSolidType_SolidMember());
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSolidType_SolidMembers());
		}
	...
	/**
	 * This returns MultiSolidType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiSolidType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiSolidType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiSolidType_type") :
			getString("_UI_MultiSolidType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiSolidType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSolidType_SolidMember(),
				 GmlFactory.eINSTANCE.createSolidPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSolidType_SolidMembers(),

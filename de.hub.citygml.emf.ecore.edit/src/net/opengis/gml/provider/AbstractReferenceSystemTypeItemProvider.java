...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractReferenceSystemType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractReferenceSystemTypeItemProvider
	extends AbstractReferenceSystemBaseTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public AbstractReferenceSystemTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractReferenceSystemType_scope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractReferenceSystemType_scope_feature", "_UI_AbstractReferenceSystemType_type"),
				 GmlPackage.eINSTANCE.getAbstractReferenceSystemType_Scope(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_SrsID());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_Remarks());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_ValidArea());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractReferenceSystemType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractReferenceSystemType_type") :
			getString("_UI_AbstractReferenceSystemType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractReferenceSystemType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_SrsID(),
				 GmlFactory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_Remarks(),
				 GmlFactory.eINSTANCE.createStringOrRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractReferenceSystemType_ValidArea(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractFeatureCollectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractFeatureCollectionTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractFeatureCollectionTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractFeatureCollectionType_FeatureMemberGroup());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractFeatureCollectionType_FeatureMembers());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractFeatureCollectionType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractFeatureCollectionType_type") :
			getString("_UI_AbstractFeatureCollectionType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractFeatureCollectionType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractFeatureCollectionType_FeatureMemberGroup(),
				 FeatureMapUtil.createEntry
					(GmlPackage.eINSTANCE.getAbstractFeatureCollectionType_FeatureMember(),
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractFeatureCollectionType_FeatureMembers(),

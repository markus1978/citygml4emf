...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.GeodeticDatumType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeodeticDatumTypeItemProvider
	extends AbstractDatumTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public GeodeticDatumTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeodeticDatumType_UsesPrimeMeridian());
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeodeticDatumType_UsesEllipsoid());
		}
	...
	/**
	 * This returns GeodeticDatumType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeodeticDatumType"));
	}
	...
	public String getText(Object object) {
		String label = ((GeodeticDatumType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_GeodeticDatumType_type") :
			getString("_UI_GeodeticDatumType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeodeticDatumType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeodeticDatumType_UsesPrimeMeridian(),
				 GmlFactory.eINSTANCE.createPrimeMeridianRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeodeticDatumType_UsesEllipsoid(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractFeatureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractFeatureTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractFeatureTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractFeatureType_BoundedBy());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractFeatureType_LocationGroup());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractFeatureType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractFeatureType_type") :
			getString("_UI_AbstractFeatureType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractFeatureType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractFeatureType_BoundedBy(),
				 GmlFactory.eINSTANCE.createBoundingShapeType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractFeatureType_LocationGroup(),
				 FeatureMapUtil.createEntry
					(GmlPackage.eINSTANCE.getAbstractFeatureType_Location(),

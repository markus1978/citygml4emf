...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.NodeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getNodeType_DirectedEdge());
			childrenFeatures.add(GmlPackage.eINSTANCE.getNodeType_PointProperty());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getNodeType_DirectedEdge(),
				 GmlFactory.eINSTANCE.createDirectedEdgePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getNodeType_PointProperty(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractCoordinateSystemType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCoordinateSystemTypeItemProvider
	extends AbstractCoordinateSystemBaseTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public AbstractCoordinateSystemTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_CsID());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_Remarks());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_UsesAxis());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractCoordinateSystemType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCoordinateSystemType_type") :
			getString("_UI_AbstractCoordinateSystemType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractCoordinateSystemType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_CsID(),
				 GmlFactory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_Remarks(),
				 GmlFactory.eINSTANCE.createStringOrRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractCoordinateSystemType_UsesAxis(),

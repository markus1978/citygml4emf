...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.PointType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getPointType_Pos());
			childrenFeatures.add(GmlPackage.eINSTANCE.getPointType_Coordinates());
			childrenFeatures.add(GmlPackage.eINSTANCE.getPointType_Coord());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPointType_Pos(),
				 GmlFactory.eINSTANCE.createDirectPositionType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPointType_Coordinates(),
				 GmlFactory.eINSTANCE.createCoordinatesType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPointType_Coord(),

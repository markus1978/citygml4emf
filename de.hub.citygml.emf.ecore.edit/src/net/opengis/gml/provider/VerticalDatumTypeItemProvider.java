...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.VerticalDatumType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VerticalDatumTypeItemProvider
	 ...
	 * @generated
	 */
	public VerticalDatumTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getVerticalDatumType_VerticalDatumType());
		}
	...
	/**
	 * This returns VerticalDatumType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VerticalDatumType"));
	}
	...
	public String getText(Object object) {
		String label = ((VerticalDatumType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_VerticalDatumType_type") :
			getString("_UI_VerticalDatumType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VerticalDatumType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getVerticalDatumType_VerticalDatumType(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getVerticalDatumType_VerticalDatumType();

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractCurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCurveTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractCurveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractCurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCurveType_type") :
			getString("_UI_AbstractCurveType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeometricAggregateType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeometricAggregateTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeometricAggregateTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractGeometricAggregateType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeometricAggregateType_type") :
			getString("_UI_AbstractGeometricAggregateType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeometricPrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeometricPrimitiveTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeometricPrimitiveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractGeometricPrimitiveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeometricPrimitiveType_type") :
			getString("_UI_AbstractGeometricPrimitiveType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.BoundedFeatureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoundedFeatureTypeItemProvider
	 ...
	 * @generated
	 */
	public BoundedFeatureTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((BoundedFeatureType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BoundedFeatureType_type") :
			getString("_UI_BoundedFeatureType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TopoCurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TopoCurveTypeItemProvider
	 ...
	 * @generated
	 */
	public TopoCurveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTopoCurveType_DirectedEdge());
		}
	...
	/**
	 * This returns TopoCurveType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TopoCurveType"));
	}
	...
	public String getText(Object object) {
		String label = ((TopoCurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TopoCurveType_type") :
			getString("_UI_TopoCurveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TopoCurveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTopoCurveType_DirectedEdge(),

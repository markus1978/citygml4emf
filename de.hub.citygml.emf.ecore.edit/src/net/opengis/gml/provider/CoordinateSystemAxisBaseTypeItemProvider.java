...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CoordinateSystemAxisBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoordinateSystemAxisBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public CoordinateSystemAxisBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoordinateSystemAxisBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CoordinateSystemAxisBaseType_type") :
			getString("_UI_CoordinateSystemAxisBaseType_type") + " " + label;
	}

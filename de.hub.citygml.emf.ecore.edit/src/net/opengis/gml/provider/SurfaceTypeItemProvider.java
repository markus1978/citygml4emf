...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.SurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public SurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getSurfaceType_PatchesGroup());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((SurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SurfaceType_type") :
			getString("_UI_SurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getSurfaceType_PatchesGroup(),
				 FeatureMapUtil.createEntry
					(GmlPackage.eINSTANCE.getSurfaceType_Patches(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeneralDerivedCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeneralDerivedCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeneralDerivedCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractGeneralDerivedCRSType_BaseCRS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractGeneralDerivedCRSType_DefinedByConversion());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractGeneralDerivedCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeneralDerivedCRSType_type") :
			getString("_UI_AbstractGeneralDerivedCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractGeneralDerivedCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractGeneralDerivedCRSType_BaseCRS(),
				 GmlFactory.eINSTANCE.createCoordinateReferenceSystemRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractGeneralDerivedCRSType_DefinedByConversion(),

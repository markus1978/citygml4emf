...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.PolarCSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolarCSTypeItemProvider
	 ...
	 * @generated
	 */
	public PolarCSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PolarCSType"));
	}
	...
	public String getText(Object object) {
		String label = ((PolarCSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_PolarCSType_type") :
			getString("_UI_PolarCSType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractGeneralTransformationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGeneralTransformationTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractGeneralTransformationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractGeneralTransformationType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGeneralTransformationType_type") :
			getString("_UI_AbstractGeneralTransformationType_type") + " " + label;
	}

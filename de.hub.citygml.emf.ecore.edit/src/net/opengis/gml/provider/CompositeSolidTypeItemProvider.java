...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CompositeSolidType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeSolidTypeItemProvider
	 ...
	 * @generated
	 */
	public CompositeSolidTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompositeSolidType_SolidMember());
		}
	...
	/**
	 * This returns CompositeSolidType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeSolidType"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeSolidType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeSolidType_type") :
			getString("_UI_CompositeSolidType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeSolidType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompositeSolidType_SolidMember(),

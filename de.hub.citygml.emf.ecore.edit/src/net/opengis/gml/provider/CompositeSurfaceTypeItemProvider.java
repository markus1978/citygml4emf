...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CompositeSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeSurfaceTypeItemProvider
	 ...
	 * @generated
	 */
	public CompositeSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompositeSurfaceType_SurfaceMember());
		}
	...
	/**
	 * This returns CompositeSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeSurfaceType_type") :
			getString("_UI_CompositeSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompositeSurfaceType_SurfaceMember(),

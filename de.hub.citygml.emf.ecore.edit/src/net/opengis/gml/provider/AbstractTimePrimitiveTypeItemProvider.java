...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTimePrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTimePrimitiveTypeItemProvider
	extends AbstractTimeObjectTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public AbstractTimePrimitiveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractTimePrimitiveType_RelatedTime());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractTimePrimitiveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTimePrimitiveType_type") :
			getString("_UI_AbstractTimePrimitiveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractTimePrimitiveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractTimePrimitiveType_RelatedTime(),

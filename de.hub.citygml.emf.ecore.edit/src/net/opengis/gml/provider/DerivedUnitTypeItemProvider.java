...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.DerivedUnitType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedUnitTypeItemProvider
	 ...
	 * @generated
	 */
	public DerivedUnitTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getDerivedUnitType_DerivationUnitTerm());
		}
	...
	/**
	 * This returns DerivedUnitType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerivedUnitType"));
	}
	...
	public String getText(Object object) {
		String label = ((DerivedUnitType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DerivedUnitType_type") :
			getString("_UI_DerivedUnitType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DerivedUnitType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDerivedUnitType_DerivationUnitTerm(),

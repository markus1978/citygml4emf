...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiSurfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiSurfaceTypeItemProvider
	extends AbstractGeometricAggregateTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public MultiSurfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSurfaceType_SurfaceMember());
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSurfaceType_SurfaceMembers());
		}
	...
	/**
	 * This returns MultiSurfaceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiSurfaceType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiSurfaceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiSurfaceType_type") :
			getString("_UI_MultiSurfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiSurfaceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSurfaceType_SurfaceMember(),
				 GmlFactory.eINSTANCE.createSurfacePropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSurfaceType_SurfaceMembers(),

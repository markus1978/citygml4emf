...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.DerivedCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedCRSTypeItemProvider
	extends AbstractGeneralDerivedCRSTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public DerivedCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getDerivedCRSType_DerivedCRSType());
			childrenFeatures.add(GmlPackage.eINSTANCE.getDerivedCRSType_UsesCS());
		}
	...
	/**
	 * This returns DerivedCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerivedCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((DerivedCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DerivedCRSType_type") :
			getString("_UI_DerivedCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DerivedCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDerivedCRSType_DerivedCRSType(),
				 GmlFactory.eINSTANCE.createDerivedCRSTypeType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDerivedCRSType_UsesCS(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getDerivedCRSType_DerivedCRSType();

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiGeometryType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiGeometryTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiGeometryTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiGeometryType_GeometryMember());
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiGeometryType_GeometryMembers());
		}
	...
	/**
	 * This returns MultiGeometryType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiGeometryType"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiGeometryType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiGeometryType_GeometryMember(),
				 GmlFactory.eINSTANCE.createGeometryPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiGeometryType_GeometryMembers(),

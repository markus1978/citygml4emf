...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CompoundCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompoundCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public CompoundCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompoundCRSType_IncludesCRS());
		}
	...
	/**
	 * This returns CompoundCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompoundCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((CompoundCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CompoundCRSType_type") :
			getString("_UI_CompoundCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompoundCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompoundCRSType_IncludesCRS(),

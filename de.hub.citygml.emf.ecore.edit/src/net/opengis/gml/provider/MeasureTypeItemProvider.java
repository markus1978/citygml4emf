...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MeasureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasureTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureType_value_feature", "_UI_MeasureType_type"),
				 GmlPackage.eINSTANCE.getMeasureType_Value(),
				 true,
				 false,
				 false,
	...
	protected void addUomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureType_uom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureType_uom_feature", "_UI_MeasureType_type"),
				 GmlPackage.eINSTANCE.getMeasureType_Uom(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		MeasureType measureType = (MeasureType)object;
		return getString("_UI_MeasureType_type") + " " + measureType.getValue();
	}

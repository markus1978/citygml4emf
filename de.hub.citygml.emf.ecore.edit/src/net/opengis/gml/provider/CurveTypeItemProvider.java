...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CurveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CurveTypeItemProvider
	 ...
	 * @generated
	 */
	public CurveTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCurveType_Segments());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CurveType"));
	}
	...
	public String getText(Object object) {
		String label = ((CurveType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CurveType_type") :
			getString("_UI_CurveType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CurveType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCurveType_Segments(),

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.CompositeValueType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeValueTypeItemProvider
	 ...
	 * @generated
	 */
	public CompositeValueTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompositeValueType_ValueComponent());
			childrenFeatures.add(GmlPackage.eINSTANCE.getCompositeValueType_ValueComponents());
		}
	...
	/**
	 * This returns CompositeValueType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeValueType"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeValueType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeValueType_type") :
			getString("_UI_CompositeValueType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeValueType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompositeValueType_ValueComponent(),
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getCompositeValueType_ValueComponents(),

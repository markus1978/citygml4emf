...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OperationMethodBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationMethodBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public OperationMethodBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getOperationMethodBaseType_MethodName());
		}
	...
	public String getText(Object object) {
		String label = ((OperationMethodBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationMethodBaseType_type") :
			getString("_UI_OperationMethodBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationMethodBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOperationMethodBaseType_MethodName(),

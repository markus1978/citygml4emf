...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractDiscreteCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractDiscreteCoverageTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractDiscreteCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractDiscreteCoverageType_CoverageFunction());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractDiscreteCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractDiscreteCoverageType_type") :
			getString("_UI_AbstractDiscreteCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractDiscreteCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractDiscreteCoverageType_CoverageFunction(),

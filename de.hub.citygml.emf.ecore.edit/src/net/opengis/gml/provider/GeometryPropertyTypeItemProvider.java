...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.GeometryPropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeometryPropertyTypeItemProvider
	 ...
	 * @generated
	 */
	public GeometryPropertyTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_actuate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_actuate_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Actuate(),
				 true,
				 false,
				 false,
	...
	protected void addArcrolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_arcrole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_arcrole_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Arcrole(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_href_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_href_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Href(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRemoteSchemaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_remoteSchema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_remoteSchema_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_RemoteSchema(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_role_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Role(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_show_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_show_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Show(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_title_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Title(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeometryPropertyType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeometryPropertyType_type_feature", "_UI_GeometryPropertyType_type"),
				 GmlPackage.eINSTANCE.getGeometryPropertyType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getGeometryPropertyType_GeometryGroup());
		}
	...
	/**
	 * This returns GeometryPropertyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeometryPropertyType"));
	}
	...
	public String getText(Object object) {
		ActuateType labelValue = ((GeometryPropertyType)object).getActuate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_GeometryPropertyType_type") :
			getString("_UI_GeometryPropertyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeometryPropertyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGeometryPropertyType_GeometryGroup(),

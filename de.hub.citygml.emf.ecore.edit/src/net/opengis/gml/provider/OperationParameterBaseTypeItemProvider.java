...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OperationParameterBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationParameterBaseTypeItemProvider
	extends AbstractGeneralOperationParameterTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public OperationParameterBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getOperationParameterBaseType_ParameterName());
		}
	...
	public String getText(Object object) {
		String label = ((OperationParameterBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationParameterBaseType_type") :
			getString("_UI_OperationParameterBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationParameterBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getOperationParameterBaseType_ParameterName(),

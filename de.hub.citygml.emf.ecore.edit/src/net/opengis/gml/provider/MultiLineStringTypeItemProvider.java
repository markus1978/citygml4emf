...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiLineStringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiLineStringTypeItemProvider
	 ...
	 * @generated
	 */
	public MultiLineStringTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiLineStringType_LineStringMember());
		}
	...
	/**
	 * This returns MultiLineStringType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiLineStringType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiLineStringType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiLineStringType_type") :
			getString("_UI_MultiLineStringType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiLineStringType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiLineStringType_LineStringMember(),

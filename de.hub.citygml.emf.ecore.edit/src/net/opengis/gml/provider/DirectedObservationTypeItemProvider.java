...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.DirectedObservationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectedObservationTypeItemProvider
	extends ObservationTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public DirectedObservationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getDirectedObservationType_Direction());
		}
	...
	/**
	 * This returns DirectedObservationType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DirectedObservationType"));
	}
	...
	public String getText(Object object) {
		String label = ((DirectedObservationType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_DirectedObservationType_type") :
			getString("_UI_DirectedObservationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DirectedObservationType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getDirectedObservationType_Direction(),

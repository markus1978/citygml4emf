...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.PrimeMeridianBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimeMeridianBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public PrimeMeridianBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getPrimeMeridianBaseType_MeridianName());
		}
	...
	public String getText(Object object) {
		String label = ((PrimeMeridianBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_PrimeMeridianBaseType_type") :
			getString("_UI_PrimeMeridianBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimeMeridianBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getPrimeMeridianBaseType_MeridianName(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getPrimeMeridianBaseType_MeridianName();

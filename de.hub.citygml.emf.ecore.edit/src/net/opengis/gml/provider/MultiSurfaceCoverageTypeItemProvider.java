...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.MultiSurfaceCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiSurfaceCoverageTypeItemProvider
	extends AbstractDiscreteCoverageTypeItemProvider
	implements
	 ...
	 * @generated
	 */
	public MultiSurfaceCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getMultiSurfaceCoverageType_MultiSurfaceDomain());
		}
	...
	/**
	 * This returns MultiSurfaceCoverageType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiSurfaceCoverageType"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiSurfaceCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiSurfaceCoverageType_type") :
			getString("_UI_MultiSurfaceCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiSurfaceCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getMultiSurfaceCoverageType_MultiSurfaceDomain(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getMultiSurfaceCoverageType_MultiSurfaceDomain() ||

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.OperationParameterGroupBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationParameterGroupBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public OperationParameterGroupBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((OperationParameterGroupBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationParameterGroupBaseType_type") :
			getString("_UI_OperationParameterGroupBaseType_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.ProjectedCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectedCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public ProjectedCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getProjectedCRSType_UsesCartesianCS());
		}
	...
	/**
	 * This returns ProjectedCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProjectedCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((ProjectedCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ProjectedCRSType_type") :
			getString("_UI_ProjectedCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProjectedCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getProjectedCRSType_UsesCartesianCS(),

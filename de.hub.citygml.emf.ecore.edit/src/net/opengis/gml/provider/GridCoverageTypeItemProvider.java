...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.GridCoverageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GridCoverageTypeItemProvider
	 ...
	 * @generated
	 */
	public GridCoverageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getGridCoverageType_GridDomain());
		}
	...
	/**
	 * This returns GridCoverageType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GridCoverageType"));
	}
	...
	public String getText(Object object) {
		String label = ((GridCoverageType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_GridCoverageType_type") :
			getString("_UI_GridCoverageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GridCoverageType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getGridCoverageType_GridDomain(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == GmlPackage.eINSTANCE.getGridCoverageType_GridDomain() ||

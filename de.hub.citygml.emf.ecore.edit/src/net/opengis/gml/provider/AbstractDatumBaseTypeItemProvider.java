...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractDatumBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractDatumBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractDatumBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractDatumBaseType_DatumName());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractDatumBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractDatumBaseType_type") :
			getString("_UI_AbstractDatumBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractDatumBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractDatumBaseType_DatumName(),

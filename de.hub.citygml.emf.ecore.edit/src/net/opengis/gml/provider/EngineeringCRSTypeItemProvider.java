...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.EngineeringCRSType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EngineeringCRSTypeItemProvider
	 ...
	 * @generated
	 */
	public EngineeringCRSTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getEngineeringCRSType_UsesCS());
			childrenFeatures.add(GmlPackage.eINSTANCE.getEngineeringCRSType_UsesEngineeringDatum());
		}
	...
	/**
	 * This returns EngineeringCRSType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EngineeringCRSType"));
	}
	...
	public String getText(Object object) {
		String label = ((EngineeringCRSType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_EngineeringCRSType_type") :
			getString("_UI_EngineeringCRSType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EngineeringCRSType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEngineeringCRSType_UsesCS(),
				 GmlFactory.eINSTANCE.createCoordinateSystemRefType()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getEngineeringCRSType_UsesEngineeringDatum(),

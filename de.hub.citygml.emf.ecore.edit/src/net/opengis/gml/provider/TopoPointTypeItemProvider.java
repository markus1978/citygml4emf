...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.TopoPointType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TopoPointTypeItemProvider
	 ...
	 * @generated
	 */
	public TopoPointTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getTopoPointType_DirectedNode());
		}
	...
	/**
	 * This returns TopoPointType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TopoPointType"));
	}
	...
	public String getText(Object object) {
		String label = ((TopoPointType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TopoPointType_type") :
			getString("_UI_TopoPointType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TopoPointType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getTopoPointType_DirectedNode(),

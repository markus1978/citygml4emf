...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractTimeSliceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractTimeSliceTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractTimeSliceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractTimeSliceType_ValidTime());
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractTimeSliceType_DataSource());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractTimeSliceType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractTimeSliceType_type") :
			getString("_UI_AbstractTimeSliceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractTimeSliceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractTimeSliceType_ValidTime(),
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractTimeSliceType_DataSource(),

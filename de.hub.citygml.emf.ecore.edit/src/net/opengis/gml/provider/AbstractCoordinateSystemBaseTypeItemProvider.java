...
/**
 * This is the item provider adapter for a {@link net.opengis.gml.AbstractCoordinateSystemBaseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractCoordinateSystemBaseTypeItemProvider
	 ...
	 * @generated
	 */
	public AbstractCoordinateSystemBaseTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.eINSTANCE.getAbstractCoordinateSystemBaseType_CsName());
		}
	...
	public String getText(Object object) {
		String label = ((AbstractCoordinateSystemBaseType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractCoordinateSystemBaseType_type") :
			getString("_UI_AbstractCoordinateSystemBaseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractCoordinateSystemBaseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.eINSTANCE.getAbstractCoordinateSystemBaseType_CsName(),

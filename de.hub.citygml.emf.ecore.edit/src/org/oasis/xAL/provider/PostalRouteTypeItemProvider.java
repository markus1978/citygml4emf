...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.PostalRouteType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PostalRouteTypeItemProvider
	 ...
	 * @generated
	 */
	public PostalRouteTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostalRouteType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostalRouteType_type_feature", "_UI_PostalRouteType_type"),
				 XALPackage.eINSTANCE.getPostalRouteType_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_PostalRouteName());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_PostalRouteNumber());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_PostBox());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalRouteType_AnyAttribute());
		}
	...
	/**
	 * This returns PostalRouteType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PostalRouteType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((PostalRouteType)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PostalRouteType_type") :
			getString("_UI_PostalRouteType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PostalRouteType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalRouteType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalRouteType_PostalRouteName(),
				 XALFactory.eINSTANCE.createPostalRouteNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalRouteType_PostalRouteNumber(),
				 XALFactory.eINSTANCE.createPostalRouteNumberType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalRouteType_PostBox(),
				 XALFactory.eINSTANCE.createPostBoxType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalRouteType_Any(),

...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.PostBoxType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PostBoxTypeItemProvider
	 ...
	 * @generated
	 */
	public PostBoxTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostBoxType_indicator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostBoxType_indicator_feature", "_UI_PostBoxType_type"),
				 XALPackage.eINSTANCE.getPostBoxType_Indicator(),
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostBoxType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostBoxType_type_feature", "_UI_PostBoxType_type"),
				 XALPackage.eINSTANCE.getPostBoxType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumber());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberPrefix());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberSuffix());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberExtension());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_Firm());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostBoxType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PostBoxType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((PostBoxType)object).getIndicator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PostBoxType_type") :
			getString("_UI_PostBoxType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PostBoxType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumber(),
				 XALFactory.eINSTANCE.createPostBoxNumberType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberPrefix(),
				 XALFactory.eINSTANCE.createPostBoxNumberPrefixType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberSuffix(),
				 XALFactory.eINSTANCE.createPostBoxNumberSuffixType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_PostBoxNumberExtension(),
				 XALFactory.eINSTANCE.createPostBoxNumberExtensionType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_Firm(),
				 XALFactory.eINSTANCE.createFirmType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostBoxType_Any(),

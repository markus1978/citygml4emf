...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.MailStopType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MailStopTypeItemProvider
	 ...
	 * @generated
	 */
	public MailStopTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MailStopType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MailStopType_type_feature", "_UI_MailStopType_type"),
				 XALPackage.eINSTANCE.getMailStopType_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getMailStopType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getMailStopType_MailStopName());
			childrenFeatures.add(XALPackage.eINSTANCE.getMailStopType_MailStopNumber());
			childrenFeatures.add(XALPackage.eINSTANCE.getMailStopType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getMailStopType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MailStopType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((MailStopType)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_MailStopType_type") :
			getString("_UI_MailStopType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MailStopType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getMailStopType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getMailStopType_MailStopName(),
				 XALFactory.eINSTANCE.createMailStopNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getMailStopType_MailStopNumber(),
				 XALFactory.eINSTANCE.createMailStopNumberType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getMailStopType_Any(),

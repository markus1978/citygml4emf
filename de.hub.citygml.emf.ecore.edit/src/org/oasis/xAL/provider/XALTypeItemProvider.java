...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.XALType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XALTypeItemProvider
	 ...
	 * @generated
	 */
	public XALTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XALType_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XALType_version_feature", "_UI_XALType_type"),
				 XALPackage.eINSTANCE.getXALType_Version(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getXALType_AddressDetails());
			childrenFeatures.add(XALPackage.eINSTANCE.getXALType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getXALType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XALType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((XALType)object).getVersion();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_XALType_type") :
			getString("_UI_XALType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(XALType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getXALType_AddressDetails(),
				 XALFactory.eINSTANCE.createAddressDetails()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getXALType_Any(),

...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.SubPremiseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubPremiseTypeItemProvider
	 ...
	 * @generated
	 */
	public SubPremiseTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubPremiseType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubPremiseType_type_feature", "_UI_SubPremiseType_type"),
				 XALPackage.eINSTANCE.getSubPremiseType_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseName());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseLocation());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumber());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumberPrefix());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumberSuffix());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_BuildingName());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_Firm());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_MailStop());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_SubPremise());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubPremiseType_AnyAttribute());
		}
	...
	/**
	 * This returns SubPremiseType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubPremiseType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((SubPremiseType)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SubPremiseType_type") :
			getString("_UI_SubPremiseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubPremiseType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseName(),
				 XALFactory.eINSTANCE.createSubPremiseNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseLocation(),
				 XALFactory.eINSTANCE.createSubPremiseLocationType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumber(),
				 XALFactory.eINSTANCE.createSubPremiseNumberType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumberPrefix(),
				 XALFactory.eINSTANCE.createSubPremiseNumberPrefixType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremiseNumberSuffix(),
				 XALFactory.eINSTANCE.createSubPremiseNumberSuffixType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_BuildingName(),
				 XALFactory.eINSTANCE.createBuildingNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_Firm(),
				 XALFactory.eINSTANCE.createFirmType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_MailStop(),
				 XALFactory.eINSTANCE.createMailStopType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_SubPremise(),
				 XALFactory.eINSTANCE.createSubPremiseType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubPremiseType_Any(),

...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.LocalityType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalityTypeItemProvider
	 ...
	 * @generated
	 */
	public LocalityTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocalityType_indicator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocalityType_indicator_feature", "_UI_LocalityType_type"),
				 XALPackage.eINSTANCE.getLocalityType_Indicator(),
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocalityType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocalityType_type_feature", "_UI_LocalityType_type"),
				 XALPackage.eINSTANCE.getLocalityType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocalityType_usageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocalityType_usageType_feature", "_UI_LocalityType_type"),
				 XALPackage.eINSTANCE.getLocalityType_UsageType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_LocalityName());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_PostBox());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_LargeMailUser());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_PostOffice());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_PostalRoute());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_Thoroughfare());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_Premise());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_DependentLocality());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getLocalityType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LocalityType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((LocalityType)object).getIndicator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_LocalityType_type") :
			getString("_UI_LocalityType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LocalityType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_LocalityName(),
				 XALFactory.eINSTANCE.createLocalityNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_PostBox(),
				 XALFactory.eINSTANCE.createPostBoxType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_LargeMailUser(),
				 XALFactory.eINSTANCE.createLargeMailUserType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_PostOffice(),
				 XALFactory.eINSTANCE.createPostOfficeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_PostalRoute(),
				 XALFactory.eINSTANCE.createPostalRouteType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_Thoroughfare(),
				 XALFactory.eINSTANCE.createThoroughfareType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_Premise(),
				 XALFactory.eINSTANCE.createPremiseType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_DependentLocality(),
				 XALFactory.eINSTANCE.createDependentLocalityType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getLocalityType_Any(),

...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.PostOfficeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PostOfficeTypeItemProvider
	 ...
	 * @generated
	 */
	public PostOfficeTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostOfficeType_indicator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostOfficeType_indicator_feature", "_UI_PostOfficeType_type"),
				 XALPackage.eINSTANCE.getPostOfficeType_Indicator(),
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostOfficeType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostOfficeType_type_feature", "_UI_PostOfficeType_type"),
				 XALPackage.eINSTANCE.getPostOfficeType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_PostOfficeName());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_PostOfficeNumber());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_PostalRoute());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_PostBox());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostOfficeType_AnyAttribute());
		}
	...
	/**
	 * This returns PostOfficeType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PostOfficeType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((PostOfficeType)object).getIndicator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PostOfficeType_type") :
			getString("_UI_PostOfficeType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PostOfficeType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_PostOfficeName(),
				 XALFactory.eINSTANCE.createPostOfficeNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_PostOfficeNumber(),
				 XALFactory.eINSTANCE.createPostOfficeNumberType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_PostalRoute(),
				 XALFactory.eINSTANCE.createPostalRouteType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_PostBox(),
				 XALFactory.eINSTANCE.createPostBoxType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostOfficeType_Any(),

...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.SubAdministrativeAreaType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubAdministrativeAreaTypeItemProvider
	 ...
	 * @generated
	 */
	public SubAdministrativeAreaTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubAdministrativeAreaType_indicator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubAdministrativeAreaType_indicator_feature", "_UI_SubAdministrativeAreaType_type"),
				 XALPackage.eINSTANCE.getSubAdministrativeAreaType_Indicator(),
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubAdministrativeAreaType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubAdministrativeAreaType_type_feature", "_UI_SubAdministrativeAreaType_type"),
				 XALPackage.eINSTANCE.getSubAdministrativeAreaType_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubAdministrativeAreaType_usageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubAdministrativeAreaType_usageType_feature", "_UI_SubAdministrativeAreaType_type"),
				 XALPackage.eINSTANCE.getSubAdministrativeAreaType_UsageType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_SubAdministrativeAreaName());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_Locality());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_PostOffice());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getSubAdministrativeAreaType_AnyAttribute());
		}
	...
	/**
	 * This returns SubAdministrativeAreaType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubAdministrativeAreaType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((SubAdministrativeAreaType)object).getIndicator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SubAdministrativeAreaType_type") :
			getString("_UI_SubAdministrativeAreaType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubAdministrativeAreaType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_SubAdministrativeAreaName(),
				 XALFactory.eINSTANCE.createSubAdministrativeAreaNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_Locality(),
				 XALFactory.eINSTANCE.createLocalityType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_PostOffice(),
				 XALFactory.eINSTANCE.createPostOfficeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getSubAdministrativeAreaType_Any(),

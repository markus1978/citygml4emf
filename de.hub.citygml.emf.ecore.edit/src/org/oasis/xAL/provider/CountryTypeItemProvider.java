...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.CountryType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CountryTypeItemProvider
	 ...
	 * @generated
	 */
	public CountryTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_CountryNameCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_CountryName());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_AdministrativeArea());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_Locality());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_Thoroughfare());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getCountryType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CountryType"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_CountryType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CountryType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_CountryNameCode(),
				 XALFactory.eINSTANCE.createCountryNameCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_CountryName(),
				 XALFactory.eINSTANCE.createCountryNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_AdministrativeArea(),
				 XALFactory.eINSTANCE.createAdministrativeAreaType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_Locality(),
				 XALFactory.eINSTANCE.createLocalityType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_Thoroughfare(),
				 XALFactory.eINSTANCE.createThoroughfareType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getCountryType_Any(),

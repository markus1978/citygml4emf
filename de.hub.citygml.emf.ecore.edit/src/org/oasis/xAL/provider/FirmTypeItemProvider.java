...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.FirmType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FirmTypeItemProvider
	 ...
	 * @generated
	 */
	public FirmTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FirmType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FirmType_type_feature", "_UI_FirmType_type"),
				 XALPackage.eINSTANCE.getFirmType_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_AddressLine());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_FirmName());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_Department());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_MailStop());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_PostalCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getFirmType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FirmType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((FirmType)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_FirmType_type") :
			getString("_UI_FirmType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FirmType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_AddressLine(),
				 XALFactory.eINSTANCE.createAddressLineType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_FirmName(),
				 XALFactory.eINSTANCE.createFirmNameType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_Department(),
				 XALFactory.eINSTANCE.createDepartmentType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_MailStop(),
				 XALFactory.eINSTANCE.createMailStopType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_PostalCode(),
				 XALFactory.eINSTANCE.createPostalCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getFirmType_Any(),

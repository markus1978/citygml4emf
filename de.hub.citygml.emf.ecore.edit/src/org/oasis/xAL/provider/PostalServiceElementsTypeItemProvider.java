...
/**
 * This is the item provider adapter for a {@link org.oasis.xAL.PostalServiceElementsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PostalServiceElementsTypeItemProvider
	 ...
	 * @generated
	 */
	public PostalServiceElementsTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PostalServiceElementsType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PostalServiceElementsType_type_feature", "_UI_PostalServiceElementsType_type"),
				 XALPackage.eINSTANCE.getPostalServiceElementsType_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressIdentifier());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_EndorsementLineCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_KeyLineCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_Barcode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_SortingCode());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLatitude());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLatitudeDirection());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLongitude());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLongitudeDirection());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_SupplementaryPostalServiceData());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_Any());
			childrenFeatures.add(XALPackage.eINSTANCE.getPostalServiceElementsType_AnyAttribute());
		}
	...
	/**
	 * This returns PostalServiceElementsType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PostalServiceElementsType"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((PostalServiceElementsType)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PostalServiceElementsType_type") :
			getString("_UI_PostalServiceElementsType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PostalServiceElementsType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressIdentifier(),
				 XALFactory.eINSTANCE.createAddressIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_EndorsementLineCode(),
				 XALFactory.eINSTANCE.createEndorsementLineCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_KeyLineCode(),
				 XALFactory.eINSTANCE.createKeyLineCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_Barcode(),
				 XALFactory.eINSTANCE.createBarcodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_SortingCode(),
				 XALFactory.eINSTANCE.createSortingCodeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLatitude(),
				 XALFactory.eINSTANCE.createAddressLatitudeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLatitudeDirection(),
				 XALFactory.eINSTANCE.createAddressLatitudeDirectionType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLongitude(),
				 XALFactory.eINSTANCE.createAddressLongitudeType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_AddressLongitudeDirection(),
				 XALFactory.eINSTANCE.createAddressLongitudeDirectionType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_SupplementaryPostalServiceData(),
				 XALFactory.eINSTANCE.createSupplementaryPostalServiceDataType()));

		newChildDescriptors.add
			(createChildParameter
				(XALPackage.eINSTANCE.getPostalServiceElementsType_Any(),
